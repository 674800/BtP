...
/**
 * Created by ybf on 2019/5/13.
 */
public class HalfCallUI {
    private String TAG = "HalfCallUI";
    protected CallUIView mlayout;
    protected WindowManager.LayoutParams mlayoutParams;

    public HalfCallUI(CallUiService service, LayoutInflater mInflater) {
        mlayout = (CallUIView) mInflater.inflate(R.layout.call_ui_half_view, null);
